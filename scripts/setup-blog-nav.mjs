...
header = header.replace(/<li class="active"><a href="index\.html">home<\/a><\/li>/, '<li><a href="index.html">home</a></li>');
header = header.replace(/<li class="active"><a href="contact\.html">contact<\/a><\/li>/, '<li><a href="contact.html">contact</a></li>');
...
const blogNav = '\t\t\t\t\t<li><a href="blog.html">blog</a></li>\n';
let updated = 0;

for (const file of fs.readdirSync(ROOT).filter((f) => f.endsWith('.html'))) {
  let html = fs.readFileSync(path.join(ROOT, file), 'utf8');
  if (html.includes('href="blog.html"')) continue;
  const contactNeedle = '<li><a href="contact.html">contact</a></li>';
  const contactActiveNeedle = '<li class="active"><a href="contact.html">contact</a></li>';
